...
while True:   # 🔹 EDIT: added loop so program keeps running until user quits
    conversion_type = input("\nEnter conversion type: quinary to decimal (q), decimal to quinary (d), or exit (x): ")

    if conversion_type.lower() == 'x':   # 🔹 EDIT: added exit option
        print("Goodbye!")
        break
    ...
    if conversion_type.lower() == 'q':
        ...
        print("Invalid choice. Please enter 'q', 'd', or 'x'.")   # 🔹 EDIT: added error handling for wrong input
